...
file_name = 'data/processed_data/yelp_big/cate/topics.txt'
topics = {}
word2topic = {}
topic_name = []
...
corpus_file = 'data/processed_data/yelp/yelp_bart.csv'
output_file = 'data/processed_data/yelp/yelp_try_0.05.txt'
corpus = []
class_num_count = {}
doc_length_total = 0
max_doc_length = 0
